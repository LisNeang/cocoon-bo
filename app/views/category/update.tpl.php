<a href="<?= $router->generate('category-list') ?>" class="btn btn-success float-right">Retour</a>
    ...
    <form action="" method="POST" class="mt-5">
        ...
        <div class="form-group">
            ...
            <input name="description" value="<?= $category ->getDescription() ?>" type="text" class="form-control" id="decription" placeholder="Description" aria-describedby="subtitleHelpBlock">
        </div>
        <div class="form-group">
            <label for="subtitle">Sous-titre</label>
            <input name="subtitle" value="<?= $category ->getSubtitle() ?>" type="text" class="form-control" id="subtitle" placeholder="Subtitle" aria-describedby="subtitleHelpBlock">
